...
import (
	...
	"github.com/4chesscom/fch/config"
	"github.com/4chesscom/fch/db"
	"github.com/4chesscom/fch/route"
...
func Index(ctx *fiber.Ctx) error {
	...
	data.Meta.Description = data.PreferredUsername + " a federated image board based on ActivityPub. The current version of the code running on the server is still a work-in-progress product, expect a bumpy ride for the time being. Get the server code here: https://github.com/4chesscom."
